---
title: "Axi's deception: A devided society can never realize its potential"
...
An axis entered to a forest and made friendship with tree, for an axis was very brave to deceived the tree's staem that, My handle is made up by one of your own. For that reason, a tree accepted and supported an axis, deceived that it's one of theirs.
![](mbulu.jpg)

Then an axis started its goal of cutting down the tree, roots, leaves and branches kept striking, but the steam kept quite. Believing at the end, they will benefit out of an axis's plans. Until a forest was finished, no handle was made out of the tree's steams.
...
- A carpenter sees a wood on tree's steam, so the steam is very important part to him.
